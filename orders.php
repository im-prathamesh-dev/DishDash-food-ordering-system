...
<div id="work-collections" class="seaction">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2024 <a class="grey-text text-lighten-4" href="#" target="_blank">Adroit Developers.</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Adroit Developers,Ahilynagar.</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
